...
async updateEventDates(){
  await Event.updateEventDates(
    Event.updateDatesFromState(this.state)
  );
}
    handleChange() {
      ...
      <div className='container' onLoad={async e => {
        ...
        <div className='content'>
          <h1>Event Administration</h1>
            ...
            <br></br>
            <h2>Event Dates</h2>
            <label>Setup Day 1:<label id="setOne"></label></label> <input name = 'setUpOne' type='date' value={this.setUpOne} onChange={this.handleChange}></input>
            <br></br>
            <label>Setup Day 2:<label id="setTwo"></label></label> <input name = 'setUpTwo' type='date' value={this.setUpTwo} onChange={this.handleChange}></input>
            <br></br>
            <label>Setup Day 3:<label id="setThree"></label></label> <input name = 'setUpThree' type='date' value={this.setUpThree} onChange={this.handleChange}></input>
            <br></br>
            <label>Dry Run:    <label id="dry"></label></label> <input name = 'dryRun' type='date' value={this.dryRun} onChange={this.handleChange}></input>
            <br></br>
            <label>Event Day 1:<label id="eventOne"></label></label> <input name = 'eventDayOne' type='date' value={this.eventDayOne} onChange={this.handleChange}></input>
            <br></br>
            <label>Event Day 2:<label id="eventTwo"></label></label> <input name = 'eventDayTwo' type='date' value={this.eventDayTwo} onChange={this.handleChange}></input>
            <br></br>
            <label>Event Day 3:<label id="eventThree"></label></label> <input name = 'eventDayThree' type='date' value={this.eventDayThree} onChange={this.handleChange}></input>
            <br></br>
            <label>Event Day 4:<label id="eventFour"></label></label> <input name = 'eventDayFour' type='date' value={this.eventDayFour} onChange={this.handleChange}></input>
            <br></br>
            <label>Event Day 5:<label id="eventFive"></label></label> <input name = 'eventDayFive' type='date' value={this.eventDayFive} onChange={this.handleChange}></input>
            <br></br>
